            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium sm:mb-0 text-gray-400">
                        ...
                        <li>
                            <a href="#" className="hover:underline me-4 md:me-6">Coran</a>
                        </li>
                        <li>
                            <a href="#" className="hover:underline me-4 md:me-6">Livres en Français</a>
                        </li>
                        <li>
                ...
                <span className="block text-sm sm:text-center text-gray-400">© 2024 <a href="#" className="hover:underline">Qassaïd en PDF</a>. Tous Droits Réservés.</span>
            </div>
        </footer>
    );
};
