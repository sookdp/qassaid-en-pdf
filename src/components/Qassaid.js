...
const Qassaid = () => {
    ...
    return (
        <div className="mt-4 sm:mt-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-200 px-6">Fichiers PDF pour les <span className="text-transparent bg-clip-text bg-gradient-to-r to-gray-600 from-gray-300">Qassaïd</span></h2>
